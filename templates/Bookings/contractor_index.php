    ...
    <div class="card card-body">
        ...
        <div class="form-row justify-content-end">
            ...
            <div class="form-group">
                <?= $this->Html->link(__('Clear Filter'), ['action' => 'index'], ['class' => 'btn btn-secondary']) ?>
            </div>
        </div>
...
<div class="card shadow mb-4 d-none d-md-block">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="contractor-bookings-table" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th></th>
                        <th>Customer</th>
...
<script>
    ...
    $(document).ready(function() {
        $('#contractor-bookings-table').DataTable({
            columnDefs: [{
