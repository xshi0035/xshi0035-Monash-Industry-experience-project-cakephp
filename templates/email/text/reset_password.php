...
Thank you for your request to reset the password of your account on <?= $this->ContentBlock->text('website-title');?>.
...
Copyright (c) <?= date("Y"); ?> <?= $this->ContentBlock->text('website-title');?>
